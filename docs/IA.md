...
| 경로 | 페이지명 | 현재 구현 방식 | 설명 |
|------|----------|---------------|------|
| `/projects/new` | 프로젝트 생성 | 모달 | 새 프로젝트 생성 폼 |
| `/projects/:id/edit` | 프로젝트 수정 | 모달 | 프로젝트 정보 수정 |
| `/settings/profile` | 프로필 설정 | 미구현 | 사용자 정보 수정 |
| `/settings/password` | 비밀번호 변경 | 미구현 | 비밀번호 변경 |
...
| 모달 | 트리거 | 내용 | 구현 상태 |
|------|--------|------|----------|
| 프로젝트 생성 모달 | "새 프로젝트" 버튼 | 이름, 설명 입력 폼 | ✅ 구현 |
| 프로젝트 수정 모달 | 프로젝트 상세 "⚙️ 설정" 버튼 | 이름, 설명 수정 폼 | ✅ 구현 |
| 이미지 상세 모달 | 히스토리 이미지 클릭 | 이미지 확대 및 액션 | ✅ 구현 |
| 부분 수정 모달 | "부분수정" 버튼 | 수정 프롬프트 입력 | ✅ 구현 |
| 삭제 확인 모달 | "삭제" 버튼 | 삭제 확인 다이얼로그 | ✅ 구현 |

### 6.2 🚧 구현 예정 모달

| 모달 | 트리거 | 내용 |
|------|--------|------|
| 다운로드 옵션 | "다운로드" 버튼 | 해상도 선택 (1K, 2K, 4K) |
